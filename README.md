...
中本聪（Satoshi Nakamoto）的比特币开创了一个全新的领域，点对点的分布式网络架构激发了人们对于去中心化世界的无穷想象。之后，维塔利克·布特林（Vitalik Buterin）尝试通过智能合约将去中心化的应用场景从单一的电子货币扩展到了通用应用领域。从此，人们就开始试图用“去中心化技术”来重构和解决当今时代的生活、商业、社会甚至国家存在的各种问题，人们的想象力扩展到了几乎无所不在的程度。
